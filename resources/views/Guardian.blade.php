...
window.addEventListener('load', function () {
  const storeId = 6; // Replace with the actual store_id you want to retrieve reviews for
    ...
    <div class="section">
      <div class="section1">
        <div class="img-slider">
          <img src="image/BioOil.jpg" alt="" class="img">
          <img src="image/cetaphil.jpg" alt="" class="img">
          <img src="image/germidine.jpg" alt="" class="img">
          <img src="image/avene.jpg" alt="" class="img">
          <img src="image/aveeno.jpeg" alt="" class="img">
        </div>
