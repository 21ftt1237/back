...
//OWNER RELATED
 Route::prefix('owner')->middleware([])->group(function () {    
    ...
    Route::delete('/comnet/delete/{id}', [OComnetController::class, 'ocomnetDeleteProduct'])->name('owner.comnet.delete');
});


  Route::get('/comnet/edit/{id}', [ComnetController::class, 'edit'])->name('comnet.edit');
  Route::put('/comnet/update/{id}', [ComnetController::class, 'update'])->name('comnet.update');
